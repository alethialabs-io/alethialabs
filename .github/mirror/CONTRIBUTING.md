...
- **Want to change the code?** Open a pull request against the monorepo:
  ...
  `apps/cli/` (and its shared library in `packages/core/`). Once your PR is merged there, it lands
  in this mirror automatically.

Thanks for helping improve the Alethia CLI!
