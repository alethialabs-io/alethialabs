---
title: core Library
description: Shared Go packages used by both Alethia CLI and Tendril agent.
---

# core Library

`packages/core/` is a shared Go module imported by both Alethia CLI and Tendril (agent). It contains the core logic for infrastructure provisioning, cloud provider interactions, and tool integrations.
