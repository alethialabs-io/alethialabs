...
After cluster provisioning, Tendril installs ArgoCD and deploys a set of supporting components via the [App of Apps pattern](/concepts/gitops-argocd). These templates live in `infra/templates/argocd/`.
