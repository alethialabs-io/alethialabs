...
- `infra/templates/project/aws/` — EKS, Aurora, ElastiCache, DynamoDB, etc.
- `infra/templates/project/gcp/` — GKE, Cloud SQL, Memorystore, Firestore, etc.
- `infra/templates/project/azure/` — AKS, Azure Database, Azure Cache, Cosmos DB, etc.

The Runner selects the correct template directory based on the Project's cloud provider and generates `terraform.tfvars` from the Project configuration.
