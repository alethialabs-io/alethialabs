...
1. The user configures infrastructure through Trellis (web form) or Alethia (CLI commands)
...
<Cards>
  ...
  <Card title="Tendril Scaling" href="/concepts/tendril-scaling">
...
└── .github/workflows/    # CI/CD (release-please, release-alethia, release-tendril)
```
