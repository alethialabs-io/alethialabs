...
| `status` | project_status enum | DRAFT → ACTIVE → DESTROYED |
...
## Project Component Tables (Singleton — 1:1 per Project)
...
## Project Component Tables (Multi-Instance — 1:N per Project)
