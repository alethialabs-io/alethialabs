...
The Runners page subscribes to `workers` table changes and `provision_jobs` changes via [Supabase Realtime](/concepts/realtime). Status changes, new registrations, and job assignments appear instantly.
