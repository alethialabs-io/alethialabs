...
<Callout type="info">
Existing networks must be in the same region as the project. The resource refresh job (`FETCH_RESOURCES`) populates the list by querying your cloud account. If you don't see a network, click the refresh button in the Provider Ribbon.
</Callout>
