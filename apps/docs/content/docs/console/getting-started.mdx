...
description: Quick start guide — sign up, connect a cloud provider, design a Spec, and deploy.
---
...
- **[Dashboard](/console/dashboard)** — manage zones and specs
- **[Design a Spec](/console/design-spec)** — deep dive into each form section
