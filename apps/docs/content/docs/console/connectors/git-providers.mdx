...
- **Repository listing** — the Design a Spec form shows repos from your connected provider
...
<Callout type="warn">
Disconnecting a Git provider affects all specs that use repositories from that provider. ArgoCD will show "sync failed" until a new token is provided.
</Callout>
