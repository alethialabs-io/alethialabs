...
The cost sidebar appears on the right side of the Design a Spec form (visible on desktop screens). It shows the estimated monthly infrastructure cost, updating in real-time as you change configuration values.
