...
The caches section configures managed in-memory cache instances. Multiple caches can be added per spec.

## Fields Per Cache

| Field | Type | Description |
|-------|------|-------------|
| **Name** | Text input | Unique per spec, lowercase |
...
The cache card in spec detail shows:
