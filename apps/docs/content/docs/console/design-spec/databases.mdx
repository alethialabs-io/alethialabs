...
The databases section configures managed relational database instances. Multiple databases can be added per spec, each with its own engine, version, and capacity settings.

## Fields Per Database

| Field | Type | Description |
|-------|------|-------------|
| **Name** | Text input | Unique per spec, lowercase, used in resource naming |
...
Once deployed, the database card in the [spec detail](/console/dashboard/spec-detail) Services tab shows:
