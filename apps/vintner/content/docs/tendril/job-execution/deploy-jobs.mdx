---
title: Deploy Jobs
description: How Tendril executes DEPLOY jobs — terraform apply, kubeconfig, and ArgoCD installation.
---
...
This prevents applying a stale plan. See [Plan & Apply](/trellis/jobs/plan-and-apply).
...
This data appears in the [Clusters page](/trellis/clusters) and vine detail.
