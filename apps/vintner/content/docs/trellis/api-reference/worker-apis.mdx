---
title: Worker APIs
description: API endpoints used by Tendril agents for job claiming, heartbeat, and log streaming.
---
...
Receives log chunks from the Tendril. See [Real-time Architecture](/concepts/realtime) for how these are delivered to the browser.
