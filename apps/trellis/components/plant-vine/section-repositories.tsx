		...
		<Card>
			<CardHeader>
				...
				<CardDescription className="text-xs">
					Template repositories are auto-configured. Select your destination repositories where infrastructure code will be pushed.
				</CardDescription>
			</CardHeader>
			<CardContent className="space-y-4">
				{isPreset && (
					<div className="p-3 rounded-lg bg-muted/20 border border-border/40 space-y-2">
						<div className="flex items-center gap-2 text-xs text-muted-foreground">
							...
							<span>
								Templates auto-configured for{" "}
								<strong className="text-foreground capitalize">{platform}</strong>
							</span>
						</div>
						<div className="grid md:grid-cols-2 gap-2">
							<div className="text-[11px]">
								<span className="text-muted-foreground">Infra template: </span>
								<code className="text-foreground">adp-tf-envtempl-standard</code>
							</div>
							<div className="text-[11px]">
								<span className="text-muted-foreground">GitOps template: </span>
								<code className="text-foreground">{templateRepo}</code>
							</div>
						</div>
					</div>
				)}
					...
					<div className="space-y-1.5">
						<div className="flex items-center gap-1.5">
							<Label className="text-xs">
								Environment Repository <span className="text-destructive">*</span>
							</Label>
						...
						<p className="text-[11px] text-muted-foreground">
							Terraform infrastructure configs for your project.
						</p>
					</div>
					<div className="space-y-1.5">
						<div className="flex items-center gap-1.5">
							<Label className="text-xs">
								GitOps Repository <span className="text-destructive">*</span>
							</Label>
						</div>
						<RepositorySelector
							label=""
						...
						/>
						<p className="text-[11px] text-muted-foreground">
							ArgoCD manifests that define what runs in your cluster.
						</p>
					</div>
				</div>
				...
				<div className="space-y-1.5">
					...
					/>
					<p className="text-[11px] text-muted-foreground">
						Your application workloads and Helm charts.
					</p>
				</div>
			</CardContent>
		</Card>
