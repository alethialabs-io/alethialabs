...
import { getZoneById, type ZoneWithSpecs, type SpecWithProvider } from "@/app/server/actions/zones";
...
export default function ZoneDetailPage() {
	...
	const handleSpecClick = (spec: SpecWithProvider) => {
		router.push(`/dashboard/zones/${id}/specs/${spec.id}`);
	};
