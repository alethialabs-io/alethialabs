...
export const jobs = pgTable(
	...
	(t) => [
		...
		// `DESC` order and the planner adds the sort back. Asserted, not assumed: the
		// integration suite EXPLAINs the real query, fails on a Sort, and carries the plain
		// `DESC` form as a control that must still plan one.
