...
const FIELD_DEFS: Record<ServiceType, FieldDef[]> = {
	...
	nosql_table: [
		{ key: "partition_key", label: "Hash Key", mono: true },
		{ key: "partition_key_type", label: "Hash Key Type", mono: true },
		{ key: "sort_key", label: "Range Key", mono: true },
		{ key: "sort_key_type", label: "Range Key Type", mono: true },
		{ key: "capacity_mode", label: "Billing", format: (v) => v === "provisioned" ? "Provisioned" : "On-Demand" },
