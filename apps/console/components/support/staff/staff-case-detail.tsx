...
import type { StaffCaseDetail as StaffCaseDetailData } from "@/lib/queries/support";
import {
	SUPPORT_CASE_TYPE_LABELS,
	SUPPORT_CATEGORY_LABELS,
} from "@/lib/validations/support";
import { CaseSeverityBadge } from "@/components/support/cases/case-severity-badge";
import { CaseStatusBadge } from "@/components/support/cases/case-status-badge";
...
export function StaffCaseDetail({
	...
	useEffect(() => {
		const source = new EventSource(
			`/api/stream/support-admin/cases/${caseId}`,
		);
