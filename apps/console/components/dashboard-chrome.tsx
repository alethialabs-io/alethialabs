...
// The shared dashboard chrome (top bar + sidebar + content scroll area). Used by
// BOTH the legacy `/dashboard/*` layout and the C2 slug tree `app/(private)/[org]/…`
// so the two URL shapes render identical chrome. Global nav stays on `/dashboard/*`
// (static routes beat the dynamic `[org]` segment); the drilldown lives under `[org]`.
