...
export function SectionCluster() {
	const { control, watch, setValue } = useFormContext<ProjectFormData>();
	...
	return (
		<Card>
			...
			<CardContent className="space-y-5">
				<ContainerPlatformSelector selected={watch("project.container_platform") || "standard"} onSelect={(v) => setValue("project.container_platform", v)} />
				...
				<div className="grid md:grid-cols-2 gap-4">
					...
					<div className="space-y-1.5">
						...
						<FormField control={control} name="project.iac_version" render={({ field }) => (
							<FormItem>
