...
interface InfrastructureTabProps {
	project: { region: string; iac_version: string; environment_stage: string };
	components: {
		network: {
...
export function InfrastructureTab({ project, components, providerMeta }: InfrastructureTabProps) {
	...
	return (
		<div className="rounded-lg border divide-y">
			...
			<InfraRow icon={Settings2} label="General">
				OpenTofu v{project.iac_version} · {project.region} · {project.environment_stage}
			</InfraRow>
		</div>
	);
}
