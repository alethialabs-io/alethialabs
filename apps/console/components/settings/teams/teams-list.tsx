...
export function TeamsList() {
  ...
  const stats = useMemo(() => {
    ...
    const distinct = new Set(
      list.flatMap((t) => t.members.map((m) => m.userId)),
    );
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This removes the team and its membership. Grants made to the team
              are revoked. Members keep their own roles. This cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
