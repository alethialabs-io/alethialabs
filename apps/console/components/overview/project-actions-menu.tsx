    ...
    <>
      <DropdownMenu>
        <DropdownMenuTrigger
          ...
          className={cn(
            "grid size-6 place-items-center rounded-sm text-muted-foreground outline-none transition-colors hover:bg-muted hover:text-foreground data-[popup-open]:bg-muted data-[popup-open]:text-foreground",
            triggerClassName,
          )}
        >
