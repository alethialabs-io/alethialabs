 ...
 *
 * Usage:
 *   pnpm -F console gen:go-validation          # regenerate
 *   pnpm -F console gen:go-validation:check    # non-zero if a committed file is stale
 *   pnpm -F console gen:go-validation:self-test  # exercise the generator's REFUSALS
 *
...
function emitGo(specs: GoSpec[]): string {
	const lines: string[] = [
		...
		"//",
		"// Regenerate with: pnpm -F console gen:go-validation",
		"//",
...
function emitCases(tables: Map<string, TableRule>): string {
	...
	const doc = {
		_doc:
			...
			"implementations over the declared cases. DO NOT EDIT. Regenerate: pnpm -F console " +
