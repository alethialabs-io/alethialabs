 ...
 *
 * Usage:
 *   pnpm -F console gen:format-conformance:check   # check — non-zero if the committed file is stale
 *   pnpm -F console gen:format-conformance        # regenerate
 *
...
function main(): void {
	...
	const doc = {
		_doc:
			...
			`DO NOT EDIT. Regenerate: pnpm -F console gen:format-conformance. Consumed by ` +
