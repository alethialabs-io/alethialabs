...
**4 of 25 proof cells are proven.** 4 failing · 1 stale (cause fixed, needs a re-run) · 0 blocked · 16 never run.
...
Ledger rows read: **24** · surviving claims: **8** (a `RETRACTED` row voids a claim rather than replacing it, so surviving < rows is expected).
