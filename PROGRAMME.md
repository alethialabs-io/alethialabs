...
**`gcp/maxconfig`** — failing. ledger 2026-08-26
...
Ledger rows read: **39** · surviving claims: **18** (a `RETRACTED` row voids a claim rather than replacing it, so surviving < rows is expected).
