...
|---|---|:---:|---|
| **aws** | `E2E_AWS_ROLE_ARN` | ✅ wired | a leg reached the gate — run 35200681925 |
| **gcp** | `E2E_GCP_WIF_PROVIDER` | ✅ wired | a leg reached the gate — run 35200681925 |
| **azure** | `E2E_AZURE_CLIENT_ID` | ✅ wired | a leg reached the gate — run 35200681925 |
| **alibaba** | `E2E_ALIBABA_ROLE_ARN` | ✅ wired | a leg reached the gate — run 35200681925 |
| **hetzner** | `HCLOUD_TOKEN` | ✅ wired | a leg reached the gate — run 35200681925 |
...
| `apps/console/e2e/gate-baseline.json` | failed: 40 · fixme: 4 · skip: 1 |
...
Live board snapshot: taken **2026-09-17T11:29:37Z** — refreshed by `.github/workflows/programme.yml`, which opens a PR rather than pushing. Warns past 48h, fails past 7 days.
