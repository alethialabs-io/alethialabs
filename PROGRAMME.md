...
|---|---|:---:|---|
| **aws** | `E2E_AWS_ROLE_ARN` | ✅ wired | a leg reached the gate — run 34681889191 |
| **gcp** | `E2E_GCP_WIF_PROVIDER` | ✅ wired | a leg reached the gate — run 34681889191 |
| **azure** | `E2E_AZURE_CLIENT_ID` | ✅ wired | a leg reached the gate — run 34681889191 |
| **alibaba** | `E2E_ALIBABA_ROLE_ARN` | ✅ wired | a leg reached the gate — run 34681889191 |
| **hetzner** | `HCLOUD_TOKEN` | ✅ wired | a leg reached the gate — run 34681889191 |
...
- #4483 — harness: CLAUDE.md §3 and `env.sh` disagree about whether an agent may restore the box, and `cmd_box` has no guard either way
...
- #4320 — backlog: 22 template variables are declared, reachable and read by no resource
...
| `apps/console/e2e/gate-baseline.json` | failed: 71 · fixme: 3 · skip: 1 |
...
Live board snapshot: taken **2026-09-12T10:34:33Z** — refreshed by `.github/workflows/programme.yml`, which opens a PR rather than pushing. Warns past 48h, fails past 7 days.
