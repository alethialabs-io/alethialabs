...
**4 of 25 proof cells are proven.** 2 failing · 1 stale (cause fixed, needs a re-run) · 0 blocked · 18 never run.
...
Ledger rows read: **23** · surviving claims: **7** (a `RETRACTED` row voids a claim rather than replacing it, so surviving < rows is expected).
