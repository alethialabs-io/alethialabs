# Alethia App — UI kit (control plane)

An interactive recreation of the **Alethia** web control plane (the product is *Trellis* in the source repo). Composes the Alethia design-system primitives — it does **not** re-implement them.
...
*Vineyard* = workspace · *Vine* = an infrastructure config · *Tendril* = a provisioning worker · *Plant a Vine* = create + provision. These are the product's real feature names; the umbrella brand is Alethia.
