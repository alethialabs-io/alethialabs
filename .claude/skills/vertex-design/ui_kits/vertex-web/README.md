# Vertex Web — UI kit (marketing landing)

A recreation of the **Vertex** marketing landing page (the source repo's `apps/trellis/components/landing`). Monochrome, editorial, terminal-forward.
...
- **Ecosystem** — module cards (Vertex web · vertex CLI).
