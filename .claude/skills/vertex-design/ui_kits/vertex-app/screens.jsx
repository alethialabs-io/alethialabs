      ...
      <div style={{ marginBottom: 30 }}>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
          ...
          {[["azure", "Azure"], ["datadog", "Datadog"]].map(([id, n]) => (
            <span key={id} style={{ display: "flex", alignItems: "center", gap: 8, padding: "6px 12px", borderRadius: 999, border: "1px dashed var(--border-strong)", fontSize: 12, color: "var(--text-tertiary)" }}>
