...
/**
 * Vertex Badge — compact metadata label.
...
try { (() => {
/* Vertex App UI kit — screen content. */
...
try { (() => {
/* Vertex App UI kit — interactive control-plane recreation.
   Composes the Vertex design-system primitives (window.VertexDesignSystem_8c015f). */
...
function SignIn({
  ...
  }, "Sign in to Vertex"), /*#__PURE__*/React.createElement("p", {
    style: {
      color: "var(--text-tertiary)",
      fontSize: 14,
      margin: "6px 0 0"
...
function Sidebar({
  ...
  }, "Vertex"), /*#__PURE__*/React.createElement(Badge, {
    variant: "outline",
    mono: true,
    style: {
      marginLeft: "auto",
...
function Header() {
  ...
  }, "Vertex"), /*#__PURE__*/React.createElement("span", {
    style: {
      ...ebw,
      fontSize: 9,
      marginLeft: 6,
...
function Features() {
  ...
  }, "Why Vertex"), /*#__PURE__*/React.createElement("h2", {
    style: {
      fontFamily: "var(--font-display)",
      fontSize: 34,
      fontWeight: 600,
...
function Ecosystem() {
  ...
  }, t === "Vertex" ? /*#__PURE__*/React.createElement(WMark, {
    size: 20
  }) : /*#__PURE__*/React.createElement("svg", {
    width: 20,
    height: 20,
...
function Footer() {
  ...
  }, "Vertex")), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 12.5,
      color: "var(--text-tertiary)",
      lineHeight: 1.6,
  ...
  }, "\xA9 2026 Alethia \xB7 Vertex Systems"), /*#__PURE__*/React.createElement("p", {
    style: {
      ...ebw,
      fontSize: 10,
      margin: 0
