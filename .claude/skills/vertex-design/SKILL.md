---
name: vertex-design
description: Use this skill to generate well-branded interfaces and assets for Vertex (the multi-cloud Kubernetes control plane by Alethia), either for production or throwaway prototypes/mocks/etc. Contains essential design guidelines, colors, type, fonts, assets, and UI kit components for prototyping. The system is fully grayscale (no color), dark-first, with Space Grotesk / Geist / Geist Mono.
user-invocable: true
---
...
- `assets/` — Vertex logo/mark, Alethia lockup, and original cloud-provider + integration brand marks.
