...
Системата трябва да позволява декларативно описание на ресурси в **AWS**. Потребителят не трябва да взаимодейства директно с облачната конзола за рутинни задачи. Платформата трябва автоматично да генерира и изпълнява **Terraform** конфигурации на базата на високоуровневи параметри, зададени от потребителя [2].
...
> **Предложение за фигура:** Архитектурна блокова схема, илюстрираща взаимодействието между Control Plane (SaaS), Execution Plane (Runners) и User Data Plane (AWS Account).
