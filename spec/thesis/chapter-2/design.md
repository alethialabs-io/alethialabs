...
*   Оркестрация на работните процеси (Triggering Runners).

#### Компонент 2: Изпълнителен панел (Execution Plane / Runner Fleet)
Това е динамичният слой на системата, съставен от множество изолирани работни процеси (Runners), работещи в ефимерни контейнери.
...
2.  **Статична компилация:** Лесно разпространение на работниците (Runners) като единичен бинарен файл.
