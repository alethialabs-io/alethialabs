...
ONE cloud-hosted runner in Alethia's AWS account (`787587782604`) serves all users. Users connect AWS via CloudFormation, configure infrastructure in Trellis, and harvest. The runner provisions into their accounts via cross-account IAM roles.
...
- [ ] **Register central runner** in Trellis (mode=cloud-hosted)
