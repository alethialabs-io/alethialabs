...
locals {
  ...
  dev_required_status_checks = [for c in var.required_status_checks : c if c != "branch-flow-guard" && c != "Release gate (hero)" && c != "Release gate (elench-ai)" && c != "Release gate (console)" && c != "Release gate (canvas)" && c != "Release gate (qa)" && c != "Release gate (audit)" && c != "Release gate (interaction)"]
  ...
  staging_required_status_checks = [for c in var.required_status_checks : c if c != "Release gate (hero)" && c != "Release gate (elench-ai)" && c != "Release gate (console)" && c != "Release gate (canvas)" && c != "Release gate (qa)" && c != "Release gate (audit)" && c != "Release gate (interaction)"]
}
