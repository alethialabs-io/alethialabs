...
module "karpenter" {
  ...
  cluster_name              = try(module.eks[0].eks_cluster_id, null) != null ? module.eks[0].eks_cluster_id : null
  queue_name                = local.karpenter_queue_name
  queue_managed_sse_enabled = true

  node_iam_role_arn    = try(module.eks[0].node_iam_role_arn, null) != null ? module.eks[0].node_iam_role_arn : null
  create_node_iam_role = false

  irsa_oidc_provider_arn          = try(module.eks[0].oidc_provider_arn, null) != null ? module.eks[0].oidc_provider_arn : null
