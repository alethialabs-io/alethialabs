...
resource "azurerm_federated_identity_credential" "app_db" {
  ...
  issuer              = try(module.aks[0].oidc_issuer_url, null) != null ? module.aks[0].oidc_issuer_url : null
...
resource "azurerm_postgresql_flexible_server_active_directory_administrator" "db_admin" {
  ...
  server_name         = try(module.azure_db[0].server_name, null) != null ? module.azure_db[0].server_name : null
  resource_group_name = azurerm_resource_group.main.name
...
resource "azurerm_mysql_flexible_server_active_directory_administrator" "db_admin" {
  ...
  server_id   = try(module.azure_db[0].server_id, null) != null ? module.azure_db[0].server_id : null
