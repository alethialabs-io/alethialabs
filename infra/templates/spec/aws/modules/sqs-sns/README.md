...
```
module "sqs" {
  source        = "git::ssh://git@gitlab.alethia.com/educatedguessteam/tf-modules/tf-module-sqs.git?ref=main"
  # In case pipeline with Token is used -> Use the below example
  #source       = "git::https://gitlab.alethia.com/educatedguessteam/tf-modules/tf-module-sqs.git?ref=v1.0.2"
