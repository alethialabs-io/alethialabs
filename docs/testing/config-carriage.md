...
Measured this run: 372 schema columns examined, 73 of them user-settable, 164 cloud verdicts. Regenerate with `pnpm -C apps/console run gen:config-carriage`. CI runs the guard on every PR.
