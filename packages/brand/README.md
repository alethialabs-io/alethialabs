...
tooling, licence, and any assignment.

Trademark symbols must be used only under the approved brand policy. Registration
of the company name is not evidence of trademark registration.

The current bracket-and-dot symbol is on a clearance hold. Do not submit it for
registration or commission a major new rollout until the action in
`docs/legal/DESIGN_SYSTEM_AUDIT.md` is closed.
