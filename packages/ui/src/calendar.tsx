...
// Ported shadcn/ui calendar (react-day-picker v9). The inline render overrides passed to
// DayPicker's `components` prop are typed via react-day-picker's `CustomComponents` (tsc
// validates them), so the runtime-oriented react/prop-types heuristic is moot here.
...
// Re-exported so consumers get the range type via @repo/ui (react-day-picker is a dep of
// this package, not the apps), keeping the calendar's selection types in one place.
export type { DateRange as CalendarRange } from "react-day-picker"
