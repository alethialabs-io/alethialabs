...
import (
	...
	"github.com/bobikenobi12/bb-thesis-2026/packages/vertex-core/assets"
...
func RunBootstrap(ctx context.Context, params BootstrapParams) (*BootstrapResult, error) {
	...
	workDir := filepath.Join(home, ".vtx", "workspaces", workspaceName)
	...
	if params.ApiClient != nil {
		fmt.Fprintln(out, "   Registering Cluster with Vertex...")
